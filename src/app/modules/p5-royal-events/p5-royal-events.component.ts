...
export class P5RoyalEventsComponent implements OnInit {
  ...
  loadSeptemberData() {
    ...
    this.months.push({
      name: 'September',
      miscMonthInfo: 'Most of this is a school trip. Keep up with social; make it through palace and Mementos',
      exitStats: [
        'Knowledge Max, Guts Max, Proficiency 4, Kindness Max, Charm Max',
        'Priestess Max, Emperor 6, Hierophant 8, Lovers Max, Chariot Max, Justice 6, Fortune 8, Hanged 7.5, Death 7.5, Temperance MAX, Devil 8, Star 8, Moon 5, Sun 4, Faith 5, Consultant 9',
      ],
      events: [
        {
          day: 1,
  ...
  loadOctoberData() {
    ...
    this.months.push({
      name: 'October',
      miscMonthInfo: 'Make sure to buy all books from Shibuya, Shinjuku, and Jinbocho.',
      exitStats: [
        'Knowledge Max, Guts Max, Proficiency Max, Kindness Max, Charm Max',
        'Priestess Max, Empress 1, Emperor 8, Hierophant 8, Lovers Max, Chariot Max, Justice 6, Hermit 5, Fortune 8, Hanged Max, Death 8, Temperance Max, Devil Max, Tower 6, Star Max, Moon 5, Sun 9, Faith 5, Consultant 9',
      ],
      events: [
        {
          day: 1,
  ...
  loadNovemberData() {
    ...
    this.months.push({
      name: 'November',
      miscMonthInfo: 'Make sure to get Consultant to rank 9 before November 17th.',
      exitStats: [
        'All Max',
        'Priestess Max, Empress 8, Emperor Max, Hierophant Max, Lovers Max, Chariot Max, Justice 8, Hermit Max, Fortune Max, Hanged Max, Death Max, Temperance Max, Devil Max, Tower Max, Star Max, Moon 8, Sun Max, Faith 5, Consultant Max',
      ],
      events: [
        {
          day: 1,
  ...
  loadDecemberData() {
    ...
    this.months.push({
      name: 'December',
      miscMonthInfo: '',
      exitStats: ['All social stats max', 'All confidants except Faith Max'],
      events: [
        {
          day: 1,
  ...
  loadJanuaryData() {
    ...
    this.months.push({
      name: 'January',
      miscMonthInfo: '',
      exitStats: ['All stats maxed', 'All confidents maxed'],
      events: [
        {
          day: 1,
          dayTimeInfo: ['All Day Story'],
  ...
  loadFebruaryData() {
    ...
    this.months.push({
      ...
      events: [
        ...
        {
          day: 2,
          dayTimeInfo: ['SAVE!', 'Gear UP!', "Fuse Faith's Ultimate Persona [Maria]", 'Talk to Violet (Faith Persona Evolution'],
          eveningInfo: ['Story; calling card sent'],
          miscInfo: [''],
        },
        {
          day: 3,
