  ...
  loadNovemberData() {
    ...
    this.months.push({
      ...
      events: [
        {
          day: 1,
          dayTimeInfo: ['Shopping Channel: Myohou Muramasa set', 'Naganaki Shrine - Get a Fortune Reading for Kazushi.'],
          eveningInfo: ['Take Koromaru for a walk. (Yukari)'],
          miscInfo: [''],
        },
        {
          day: 2,
          dayTimeInfo: ['Hang out with Kazushi.', '(1) (Chariot Rank 9)'],
          eveningInfo: ['Story Event. (Fool Rank 6)', 'Iwatodai Dorm Shared Computer - Select Iwatodai Forum Note.'],
          miscInfo: [''],
        },
        {
          day: 3,
          dayTimeInfo: ['Mandatory Story Battle.'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
          day: 4,
          dayTimeInfo: ['Head out of the Classroom.'],
          eveningInfo: ['Story Event. (Fool Rank 7)'],
          miscInfo: ['Story Event. (Death Rank 10)'],
        },
        {
          day: 5,
          dayTimeInfo: [''],
          eveningInfo: ['Iwatodai Dorm Shared Computer - Select Muscle Boot Camp.'],
          miscInfo: [''],
        },
        {
          day: 6,
          dayTimeInfo: [
            'Gekkoukan High School Corridor - Talk to the Friendly Student by the Persimmon Tree',
            'Hang out with Bebe.',
            '(2) (Temperance Rank 9)',
          ],
          eveningInfo: ['Iwatodai Dorm Shared Computer - Select Mindful Boot Camp'],
          miscInfo: [''],
        },
        {
          day: 7,
          dayTimeInfo: ['Hang out with Junpei. (Linked Episode 3)'],
          eveningInfo: ['Take Koromaru for a walk. (Mamoru)'],
          miscInfo: ['Question Answer: The Upanishads.'],
        },
        {
          day: 8,
          dayTimeInfo: [
            'Shopping Channel: Japanese Doll set',
            'Port Island Station Flower Shop - Buy a White Flower.',
            'Hang out with Akinari.',
            '(1, 1) (Sun Rank 6)',
          ],
          eveningInfo: ['Give the White Flower to Junpei.', 'Take Koromaru for a walk. (Yuko)'],
          miscInfo: [''],
        },
        {
          day: 9,
          dayTimeInfo: [''],
          eveningInfo: [
            'Paulownia Mall - Buy all notes from the Suspicious Man in Club Escapade',
            'Iwatodai Strip Mall - Buy all of the available software at the Net Cafe',
            'Iwatodai Dorm Shared Computer - Select Veggie Blog Note',
          ],
          miscInfo: [''],
        },
        {
          day: 10,
          dayTimeInfo: ['Hang out with Keisuke.', '(1, Any, Any, Any, Any) (Fortune Rank 9)'],
          eveningInfo: ['Hang out with Ken. (Linked Episode 3)'],
          miscInfo: [''],
        },
        {
          day: 11,
          dayTimeInfo: ['Hang out with Keisuke. (Fortune Rank 10)'],
          eveningInfo: ['Talk to Aigis and read with her.'],
          miscInfo: [''],
        },
        {
          day: 12,
          dayTimeInfo: ['Hang out with Ryoji. (Linked Episode 1)'],
          eveningInfo: ['Talk to Fuuka and read with her'],
          miscInfo: ['Question Answer: Her favorite time in winter.'],
        },
        {
          day: 13,
          dayTimeInfo: ['Hang out with Kenji. (Magician Rank 10)'],
          eveningInfo: ['Talk to Yukari and cook with her.'],
          miscInfo: [''],
        },
        {
          day: 14,
          dayTimeInfo: ['Hang out with Chihiro.', '(1, 2, Any, 1, 1(romance)/2(platonic), Any) (Justice Rank 9)'],
          eveningInfo: ['Take Koromaru for a walk. (Chihiro)'],
          miscInfo: ['Any option.'],
        },
        {
          day: 15,
          dayTimeInfo: ["Shopping Channel: Sid's Jacket set", 'Accept phone invitation from Fuuka. (1)'],
          eveningInfo: ['Talk to Aigis and head to the Garden with her.'],
          miscInfo: [''],
        },
        {
          day: 16,
          dayTimeInfo: ['Hang out with Fuuka.', '(Any, Any, 1(romance)/2(platonic), 1) (Priestess Rank 9)'],
          eveningInfo: ['Iwatodai Dorm Shared Computer - Select Security Site Note'],
          miscInfo: ['Any option'],
        },
        {
          day: 17,
          dayTimeInfo: [''],
          eveningInfo: ['Buy the Kyoto exclusive items at the souvenir shop', 'Buy the Kyoto exclusive items at the Vending Machine'],
          miscInfo: [''],
        },
        {
          day: 18,
          dayTimeInfo: [''],
          eveningInfo: ['Agree to hang out with Ryoji tomorrow. (Linked Episode 2)'],
          miscInfo: [''],
        },
        {
          day: 19,
          dayTimeInfo: [''],
          eveningInfo: ['Escape from the Hot Springs. (1, 1, 2) (Optional)'],
          miscInfo: [''],
        },
        {
          day: 20,
          dayTimeInfo: [''],
          eveningInfo: ['Give Ken a souvenir', 'Take Koromaru for a walk. (Ken)'],
          miscInfo: [''],
        },
        {
          day: 21,
          dayTimeInfo: ['Faculty Office Hallway - Hang out with Mitsuru. (Empress Rank 1)'],
          eveningInfo: ['Talk to Fuuka and head to the Garden with her.'],
          miscInfo: ['Any option.'],
        },
        {
          day: 22,
          dayTimeInfo: ['Shopping Channel: Garnet set', 'Hang out with Akinari.', '(2) (Sun Rank 7)'],
          eveningInfo: ['Talk to Ken and make Coffee with him.'],
          miscInfo: [''],
        },
        {
          day: 23,
          dayTimeInfo: ['Naganaki Shrine - Get a Fortune Reading for Hidetoshi'],
          eveningInfo: ['Iwatodai Dorm Shared Computer - Select Mental Instructor'],
          miscInfo: [''],
        },
        {
          day: 24,
          dayTimeInfo: ['Career Experience'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
        ...
        },
        {
          day: 27,
          dayTimeInfo: ['Career Experience'],
          eveningInfo: ['Brush Koromaru', "Talk to Koromaru, obtain Dog Food, and complete Elizabeth's 94th Request"],
          miscInfo: [''],
        },
        {
          day: 28,
          dayTimeInfo: ['Hang out with Mitsuru.', '(2) (Empress Rank 2)'],
          eveningInfo: ['Story Event. (Fool Rank 9)', 'Club Escapade - Get a Fortune Reading', 'Head to Tartarus'],
          miscInfo: [
            'Reach Floor 198',
            'Open the chest at the deepest point of the Monad Passage on Floor 197F',
            'Have at least 100,000 Yen after selling materials tomorrow',
            'Rescue the 2 Missing Persons',
          ],
        },
        {
          day: 29,
          dayTimeInfo: [
            'Shopping Channel: Shoes of Bane set',
            'Sell all of your materials. (If You are holding less than 100,000 Yen, reload)',
            'Collect your reward at the Police Station',
            'Hang out with Akinari.',
            '(1, 2) (Sun Rank 8)',
          ],
          eveningInfo: ["Talk to Ken, obtain Featherman R Figure, and complete Elizabeth's 95th Request", 'Talk to Ken and make Coffee with him'],
          miscInfo: [''],
        },
        {
          day: 30,
          dayTimeInfo: ['Hang out with Hidetoshi in the Student Council Room. (Emperor Rank 10)'],
          eveningInfo: ['Talk to Mitsuru and have some tea with her'],
          miscInfo: ['Question Answer: The cherry blossom'],
        },
      ] as Array<MonthEvent>,
    } as MonthEvents);
  }
  ...
  loadDecemberData() {
    ...
    this.months.push({
      ...
      events: [
        {
          day: 1,
          dayTimeInfo: ['Hang out with Ryoji. (Linked Episode 3)'],
          eveningInfo: ['Talk to Fuuka and head to the Garden with her.'],
          miscInfo: [''],
        },
        {
          day: 2,
          dayTimeInfo: ['Hang out with Mitsuru.', '(2, 2, 2, 2) (Empress Rank 3)'],
          eveningInfo: ['Talk to Junpei and head to the Garden with him.'],
          miscInfo: [''],
        },
        {
          day: 3,
          ...
          eveningInfo: [
            'Paulownia Mall – Buy all notes from the Suspicious Man in Club Escapade.',
            'Iwatodai Dorm Shared Computer – Select Ninja Fansite Note',
          ],
          miscInfo: [''],
        },
        {
          day: 4,
          dayTimeInfo: ['Hang out with Mitsuru.', '(2, 1, Any) (Empress Rank 4)'],
          eveningInfo: ['Brush Koromaru.'],
          miscInfo: [''],
        },
        {
          day: 5,
          dayTimeInfo: ['Hang out with Mitsuru.', '(2, 1, 2) (Empress Rank 5)'],
          eveningInfo: ['Iwatodai Dorm Shared Computer – Select History Website Note'],
          miscInfo: [''],
        },
        {
          day: 6,
          dayTimeInfo: ['Shopping Channel: Hogyoku Apple set', 'Hang out with Akinari.', '(2) (Sun Rank 9)'],
          eveningInfo: ['Brush Koromaru'],
          miscInfo: [''],
        },
        {
          day: 7,
          dayTimeInfo: ['Hang out with Mitsuru.', '(1, Any, 2, 3) (Empress Rank 6)'],
          eveningInfo: ['Iwatodai Dorm Shared Computer – Select Assassin Site Note'],
          miscInfo: ['Question Answer: The ozone layer.'],
        },
        {
          day: 8,
          dayTimeInfo: ['Hang out with Mitsuru.', '(1) (Empress Rank 7)'],
          eveningInfo: ['Take Koromaru for a walk. (Chihiro)'],
          miscInfo: [''],
        },
        {
          day: 9,
          dayTimeInfo: ['Hang out with Mitsuru.', '(Any, 1, 1, 2, 1) (Empress Rank 8)'],
          eveningInfo: ['Study with Ken and Koromaru'],
          miscInfo: ['Question Answer: Kido'],
        },
        {
          day: 10,
          dayTimeInfo: ['Hang out with Mitsuru. (3, Any, 1(romance)/2(platonic), Any(platonic)) (Empress Rank 9)'],
          eveningInfo: ['Iwatodai Dorm Shared Computer – Select Dating Site Note. (Choose Yukari)'],
          miscInfo: [''],
        },
        {
          day: 11,
          dayTimeInfo: ['Hang out with Mitsuru. (Empress Rank 10)'],
          eveningInfo: [
            'Paulownia Mall – Buy Dating Site Note from the Suspicious Man in Club Escapade',
            'Iwatodai Dorm Shared Computer – Select Dating Site Note. (Choose Old Couple)',
          ],
          miscInfo: ['Question Answer: Lives'],
        },
        {
          day: 12,
          dayTimeInfo: ['Hang out with The Old Couple. (Hierophant Rank 10)'],
          eveningInfo: ['Hang out with Akihiko. (Linked Episode 4)'],
          miscInfo: ['Any option'],
        },
        {
          day: 13,
          dayTimeInfo: ['Shopping Channel: Victory Headband set', 'Hang out with Akinari. (Sun Rank 10)'],
          eveningInfo: ['Talk to Yukari and Fuuka to study with everyone'],
          miscInfo: [''],
        },
        {
          day: 14,
          dayTimeInfo: ['Question Answer: The number zero'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
          day: 15,
          dayTimeInfo: ['Question Answer: Maltose.'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
          day: 16,
          dayTimeInfo: ['Question Answer: Venus'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
          day: 17,
          dayTimeInfo: ['Question Answer: Murasaki-no-Ue'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
          day: 18,
          dayTimeInfo: ['Question Answer: Geeses'],
          eveningInfo: [''],
          miscInfo: [''],
        },
        {
          day: 19,
          dayTimeInfo: ['Hang out with Junpei. (Linked Episode 4)'],
          eveningInfo: ['Take Koromaru for a walk. (Kenji)'],
          miscInfo: [''],
        },
        {
          day: 20,
          dayTimeInfo: ['Shopping Channel: Pink Duffle Coat set', 'Hang out with Mamoru.', '(1, 2, 1, 1) (Star Rank 9)'],
          eveningInfo: [
            'Accept Request 97 from Elizabeth and talk to the man on the second floor of Iwatodai Strip Mall.',
            'If you saved the Missing Person “Ayako Yoshimoto” back in June, on floor 50, you can trade the Thank You Note for a Christmas Present.',
            'Bring the Present to Elizabeth to complete the Request',
            'Iwatodai Dorm Shared Computer – Select Image Muscle Trainer',
          ],
          miscInfo: [''],
        },
        {
          day: 21,
          dayTimeInfo: ['Talk to Mitsuru in the Faculty Office Hallway to receive a reward for your exam score', 'Hang out with Fuuka. (Priestess Rank 10)'],
          eveningInfo: ['Take Koromaru for a walk. (Fuuka)'],
          miscInfo: ['Exam Results: Top Score', 'Afternoon: Any option.'],
        },
        {
          day: 22,
          dayTimeInfo: ['Hang out with Bebe. (Temperance Rank 10)'],
          eveningInfo: ['Hang out with Ken. (Linked Episode 4)'],
          miscInfo: ['Question Answer: Euphoria'],
        },
        {
          day: 23,
          dayTimeInfo: ['Hang out with Mamoru. (Star Rank 10)'],
          eveningInfo: ['Club Escapade – Get a Fortune Reading', 'Head to Tartarus'],
          miscInfo: [
            'Reach Floor 226',
            'Reach Level 47',
            'Open the chest at the deepest point of the Monad Passage on Floor 225F',
            'Have at least 100,000 Yen after selling materials tomorrow',
            'Rescue the 2 Missing Persons',
          ],
        },
        {
          day: 24,
          dayTimeInfo: ['Christmas Eve Date'],
          eveningInfo: [
            'Sell all of your materials. (If You are holding less than 100,000 Yen, reload)',
            'Collect your reward at the Police Station',
            'Iwatodai Dorm Shared Computer – Select Veggie Farmer Sim.',
          ],
          miscInfo: [''],
        },
        {
          day: 25,
          dayTimeInfo: ['Hang out with Kazushi. (Chariot Rank 10)'],
          eveningInfo: ['Watch TV with Ken'],
          miscInfo: [''],
        },
        {
          day: 26,
          dayTimeInfo: ['Hang out with Yuko. (Strength Rank 10)'],
          eveningInfo: ['Watch TV with Akihiko.'],
          miscInfo: ['Any option.'],
        },
        {
          day: 27,
          dayTimeInfo: ['Shopping Channel: Ruby set', 'Hang out with Nozomi. (Moon Rank 10)'],
          eveningInfo: ['Talk to Ken and make Coffee with him'],
          miscInfo: [''],
        },
        {
          day: 28,
          dayTimeInfo: ['Port Island Station – Watch a movie at Screen Shot'],
          eveningInfo: ['Talk to Mitsuru and have some tea with her.'],
          miscInfo: [''],
        },
        {
          day: 29,
          dayTimeInfo: ['Port Island Station – Work Part-Time at Screen Shot'],
          eveningInfo: ['Watch TV with Yukari'],
          miscInfo: [''],
        },
        {
          day: 30,
          dayTimeInfo: ['Paulownia Mall Be Blue V – Work Part-Time or Accept treatment'],
          eveningInfo: ['Story Event', 'Iwatodai Dorm Shared Computer – Select Part-Time Master.'],
          miscInfo: [''],
        },
        {
          day: 31,
          dayTimeInfo: ['Paulownia Mall Be Blue V – Work Part-Time or Accept treatment'],
          eveningInfo: [
            'After entering your room, select these options to stay on the Good Ending path.',
            '(1, 1)',
            'Automatic Story Event if you watched all of Ryoji’s Linked Episodes. (Ryoji’s Linked Episode Ending)',
            'Story Event. (Fool Rank 10)',
            'Story Event. (Judgment Rank 1)',
          ],
          miscInfo: [''],
        },
      ] as Array<MonthEvent>,
  ...
  loadJanuaryData() {
    ...
    this.months.push({
      ...
      events: [
        {
          day: 1,
          dayTimeInfo: ['Talk to Mitsuru when you are ready to leave the Shrine.'],
          eveningInfo: ['Watch TV with Ken.'],
          miscInfo: [''],
        },
        {
          day: 2,
          dayTimeInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats.'],
          eveningInfo: ['Iwatodai Dorm Command Room – Watch the new Video Recordings', 'Watch TV with Akihiko'],
          miscInfo: [''],
        },
        {
          day: 3,
          dayTimeInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          eveningInfo: ['Iwatodai Dorm Shared Computer – Select Pickup Line Master.'],
          miscInfo: [''],
        },
        {
          day: 4,
        ...
        {
          day: 5,
          dayTimeInfo: ['Hang out with Koromaru. (Koromaru’s Linked Episode Ending)'],
          eveningInfo: ['Iwatodai Dorm Shared Computer – Select Sage Brain Training'],
          miscInfo: [''],
        },
        {
          day: 6,
          dayTimeInfo: ['Accept phone invitation from Chihiro'],
          eveningInfo: ['Talk to Aigis and read with her'],
          miscInfo: [''],
        },
        {
          day: 7,
          dayTimeInfo: ['Accept phone invitation from Yukari'],
          eveningInfo: ['Take Koromaru for a walk'],
          miscInfo: [''],
        },
        {
          day: 8,
          dayTimeInfo: ['Gekkoukan High School Classroom – Hang out with Aigis'],
          eveningInfo: ['Hang out with Akihiko. (Akihiko’s Linked Episode Ending)'],
          miscInfo: ['Question Answer: The underworld'],
        },
        {
          day: 9,
          dayTimeInfo: ['Hang out with Chihiro. (Justice Rank 10)'],
          eveningInfo: ['Talk to Aigis and head to the Garden with her'],
          miscInfo: [''],
        },
        {
        ...
        },
        {
          day: 11,
          dayTimeInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          eveningInfo: ['Iwatodai Dorm Shared Computer – Select Sengoku Chronicles'],
          miscInfo: [''],
        },
        {
          day: 12,
          dayTimeInfo: ['Hang out with Aigis.', '(1) (Aeon Rank 2)'],
          eveningInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          miscInfo: ['Any option'],
        },
        {
          day: 13,
          dayTimeInfo: ['Hang out with Aigis.', '(Any, 2) (Aeon Rank 3)'],
          eveningInfo: ['Talk to Aigis and read with her'],
          miscInfo: [''],
        },
        {
          day: 14,
          dayTimeInfo: ['Hang out with Aigis.', '(2, 1, Any) (Aeon Rank 4)'],
          eveningInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          miscInfo: [''],
        },
        {
          day: 15,
          dayTimeInfo: ['Hang out with Junpei. (Junpei’s Linked Episode Ending)'],
          eveningInfo: ['Watch TV with Ken'],
          miscInfo: ['Any option'],
        },
        {
          day: 16,
          dayTimeInfo: ['Hang out with Aigis.', '(1) (Aeon Rank 5)'],
          eveningInfo: ['Talk to Junpei and head to the Garden with him'],
          miscInfo: [''],
        },
        {
          day: 17,
          dayTimeInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          eveningInfo: ['Club Escapade – Talk to the Suspicious-Looking man and agree to meet the Messiah'],
          miscInfo: [''],
        },
        {
          day: 18,
          dayTimeInfo: ['Hang out with Aigis.', '(2) (Aeon Rank 6)'],
          eveningInfo: ['Talk to Junpei and read with him'],
          miscInfo: ['Question Answer: Circe'],
        },
        {
          day: 19,
          dayTimeInfo: ['Hang out with Aigis.', '(Any, Any, Any) (Aeon Rank 7)'],
          eveningInfo: ['Hang out with Ken. (Ken’s Linked Episode Ending)'],
          miscInfo: [''],
        },
        {
          day: 20,
          dayTimeInfo: ['Hang out with Yukari.', '(Lovers Rank 10)'],
          eveningInfo: [
            'Paulownia Mall – Buy Believer’s Blog Note from the Suspicious Man in Club Escapade',
            'Iwatodai Dorm Shared Computer – Select Believer’s Blog Note',
          ],
          miscInfo: [''],
        },
        {
          day: 21,
          dayTimeInfo: ['Story Event if you gave the White Flowers to Junpei back in November'],
          eveningInfo: ['Club Escapade – Get a Fortune Reading', 'Head to Tartarus'],
          miscInfo: [
            'Reach Floor 256. (Judgment Rank 10)',
            'Open the chest at the deepest point of the Monad Passage on Floor 255F',
            'Have at least 100,000 Yen after selling materials tomorrow',
            'Rescue the 2 Missing Persons',
            'Defeat the Reaper',
            'Reach level 91 and Fuse Messiah',
          ],
        },
        {
          day: 22,
        ...
        {
          day: 23,
          dayTimeInfo: ['Hang out with Aigis.', '(1, 1(Romantic)/2(Platonic)) (Aeon Rank 9)'],
          eveningInfo: ['Talk to Junpei and head to the Garden with him'],
          miscInfo: [''],
        },
        {
        ...
        {
          day: 25,
          dayTimeInfo: ['Catch up with a Social Link if you are behind on one, otherwise, head to the Arcade'],
          eveningInfo: ['Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          miscInfo: ['Any option'],
        },
        {
          day: 26,
          dayTimeInfo: ['Hang out with Aigis. (Aeon Rank 10)'],
          eveningInfo: ['Head to The Velvet Room to receive the Colorless Mask', 'Paulownia Mall Arcade – Play something to raise a Persona’s stats'],
          miscInfo: [''],
        },
        {
          day: 27,
          dayTimeInfo: [
            'All Social Links, Linked Episodes, and Dorm events have been completed by this point.',
            'You should spend the rest of your time cleaning up any links that you might be behind on if you forgot to bring the corresponding arcana.',
            'If you are on schedule, you can spend the rest of your time, boosting stats in the Arcade, finishing up any remaining requests, or grinding in Tartarus',
          ],
          eveningInfo: ['Free Time'],
          miscInfo: [''],
        },
        {
          day: 28,
          dayTimeInfo: ['Free Time'],
          eveningInfo: ['Free Time'],
          miscInfo: ['Any option'],
        },
        {
          day: 29,
          dayTimeInfo: ['Free Time'],
          eveningInfo: ['Take Koromaru for a walk. (Everyone)'],
          miscInfo: [''],
        },
        {
          day: 30,
          dayTimeInfo: ['Free Time'],
          eveningInfo: [
            'Tomorrow is your last chance to redeem gems at the Antique Shop.',
            'Head to Tartarus tonight and farm gems if you need anything from the Antique Shop',
          ],
          miscInfo: [''],
        },
        {
          day: 31,
          dayTimeInfo: ['Iwatodai Dorm Command Room – Watch the new Video Recording', 'Free Time'],
          eveningInfo: ['Buy anything you need from the shops as this is the point of no return', 'Club Escapade – Get a Fortune Reading', 'Head to Tartarus'],
          miscInfo: [
            'Accept Request 101, and Defeat Elizabeth at the deepest point of the Monad Passage on Floor 255F',
            'Finish the remaining requests for Elizabeth',
            'Reach The Top Floor and defeat Nyx',
          ],
        },
      ] as Array<MonthEvent>,
    } as MonthEvents);
  ...
  loadMarchData() {
    ...
    this.months.push({
      ...
      events: [
        {
          day: 4,
          dayTimeInfo: ['View the ending scenes for everyone’s Social Link and Linked Episode'],
          eveningInfo: ['Talk to Yukari and check the photo for a short scene.', 'Head to the Garden and harvest your vegetables'],
          miscInfo: [''],
        },
      ] as Array<MonthEvent>,
    } as MonthEvents);
