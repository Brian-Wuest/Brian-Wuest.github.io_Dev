...
@Component({
    ...
    styleUrls: ['./starfinder.component.css']
})
export class StarfinderComponent implements OnInit {
    ...
    createRaceInfo() {
        this.races = [
            new Race('Android',
                [new AttributeModifier('DEX', 2), new AttributeModifier('INT', 2), new AttributeModifier('CHR', -2)]),
            new Race('Human', []),
            new Race('Kasatha',
                [new AttributeModifier('STR', 2), new AttributeModifier('WIS', 2), new AttributeModifier('INT', -2)]),
            new Race('Lashunta (Damaya)',
                [new AttributeModifier('INT', 2), new AttributeModifier('CHR', 2), new AttributeModifier('CON', -2)]),
            new Race('Lashunta (Korasha)',
                [new AttributeModifier('STR', 2), new AttributeModifier('CHR', 2), new AttributeModifier('WIS', -2)]),
            new Race('Shirren',
                [new AttributeModifier('CON', 2), new AttributeModifier('WIS', 2), new AttributeModifier('CHR', -2)]),
            new Race('Vesk',
                [new AttributeModifier('STR', 2), new AttributeModifier('CON', 2), new AttributeModifier('INT', -2)]),
            new Race('Ysoki',
                [new AttributeModifier('DEX', 2), new AttributeModifier('INT', 2), new AttributeModifier('STR', -2)]),
        ];
    }
